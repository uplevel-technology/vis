  ...
  if (restack) {
    ...
    if (typeof this.itemSet.options.order === 'function') {
      ...
      if (this.doInnerStack && this.itemSet.options.stackSubgroups) {
        ...
        stack.stack(customOrderedItems, margin, true /* restack=true */, this.itemSet.options.maxStackHeight);
      }
      ...
      if (this.itemSet.options.stack) {
        if (this.doInnerStack && this.itemSet.options.stackSubgroups) {                    
          ...
          stack.stack(this.visibleItems, margin, true /* restack=true */, this.itemSet.options.maxStackHeight);
        }
      } else {
        // no stacking
